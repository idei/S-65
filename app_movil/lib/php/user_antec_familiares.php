<?php
    ...
    $cod_event_colesterol = $_POST['cod_event_colesterol'];
        ...
        try {
                ...
                $select_id_paciente = $db->prepare("SELECT rela_paciente FROM antecedentes_medicos_familiares WHERE rela_paciente = '".$id_paciente."'");
                $select_id_paciente->execute();
                ...
                if ($select_id_paciente->rowCount() > 0) {
                        ...
                        $delete_antecedentes = $db->prepare("DELETE from antecedentes_medicos_familiares
                ...
                pdoMultiInsert('antecedentes_medicos_familiares', $rowsToInsert, $db);
