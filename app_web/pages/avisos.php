        ...
        <div class="container">
            ...
            <div class="row" style="margin: 100; color: rgb(92, 90, 90);">
                <div class="p-5">
                    ...
                    <div class="row">
          <div class="col-sm">
          <button class="btn btn-danger float-right" onclick="$('#nuevoAvisoGrupalModal').modal('show')"><i class="fa fa-users" aria-hidden="true"></i> Crear Anuncio Grupal</button>
          </div>
          <div class="col-sm">
          <button class="btn btn-primary float-right" onclick="$('#nuevoAvisoModal').modal('show')"><i class="fa fa-user" aria-hidden="true"></i> Crear Anuncio Individual</button>
          </div>
          <div class="col-sm">
...
<script>
    ...
    function return_options_selected() {
        ...
        $.ajax({
            ...
            url: '../php/read_deptos_sexo.php',
            type: 'POST',
            dataType: "JSON",

            success: function(response) {

                if (response['request'] == 'Success' && option_value == 2) {
                ...
                if (response['request'] == 'Success' && option_value == 1) {
                    options_selected.innerHTML = ``;
